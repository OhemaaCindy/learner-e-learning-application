const AchievementSection = () => {
  ...
  return (
    <div>
      ...
      <div className=" py-4 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-4 ">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:flex-wrap lg:flex-nowrap justify-center items-stretch gap-8 sm:gap-10 md:gap-12 lg:gap-16  ">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="flex-1 flex flex-col items-start text-center relative min-w-0 sm:min-w-[250px] lg:min-w-0 "
              >
                ...
                {index < stats.length - 1 && (
                  <div className="hidden lg:flex absolute -right-8 top-1/2 transform -translate-y-1/2 w-px h-50 bg-[#679BC2]"></div>
                )}
