...
//           className={cn(
//             "w-full px-3 py-3 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-left flex items-center justify-between",
//             iconLeft && "pl-10",
...
//   const paymentOptions = ["Credit Card", "PayPal", "Bank Transfer", "Crypto"];
//   const amountOptions = ["50", "100", "200", "350", "500"];
...
//     register("amount").onChange({ target: { name: "amount", value: amount } });
...
//                       rows={4}
//                       className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none resize-none bg-gray-50"
...
//                 <button
//                   type="submit"
//                   className="w-full bg-[#02589A] hover:bg-blue-300 text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2"
//                 >
...
//           className={cn(
//             "w-full px-3 py-3 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent",
//             iconLeft && "pl-10",
